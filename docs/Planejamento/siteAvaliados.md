...
!!! Warning "Sobre o conteúdo dessa página"

    Os sites descritos abaixo, com exceção do UnB Idiomas **não foram própriamente avaliados pela equipe**. A descrição dos demais sites, disponibilizada nessa página representa apenas os sites que foram cogitados e brevemente investigados pelos membros da equipe de Design, durante o processo de escolha do objeto definitivo de pesquisa deste trabalho, que por sua vez foi o UnB Idiomas.
...
Entre essas exigências, uma das mais solicitadas nos tempos atuais é a fluência em um segundo ou até mesmo terceiro idioma sendo assim o grupo escolheu o UnB Idiomas como site do projeto para a disciplina.

Além disso, durante a avaliação Heurística do UnB Idiomas, foram identificados pontos de melhoria na interface, na navegação e na pevisibilidade, nos quais acreditamos que nosso trabalho pode contribuir com a aplicação como um todo.
...
<figcaption align="center">Figura 1: Logo do UnB Idiomas. Fonte: (UnB Idiomas, 2020)</figcaption>
</div>
<br/>
...
<figcaption align="center">Figura 2: Logo do Sebrae. Fonte: (Sebrae, 2020)</figcaption>
</div>
<br/>
...
<figcaption align="center">Figura 3: Logo do Conect SUS. Fonte: (Conecte SUS, 2020)</figcaption>
</div>
<br/>
...
<figcaption align="center">Figura 4: Logo do Moovit. Fonte: (Moovit, 2020)</figcaption>
</div>
<br/>
...
<figcaption align="center">Figura 5: Logo da FGA UnB. Fonte: (FGA UnB, 2020)</figcaption>
</div>
<br/>
...
<figcaption align="center">Figura 6: Logo do Enade INEP. Fonte: (Enade INEP, 2020)</figcaption>
</div>
<br/>
...
| 12/11/2022 |  1.2   | Remoção das críticas aos sites e descrição do conteúdo da página |       Eric Chagas       |    Thiago Cerqueira     |
